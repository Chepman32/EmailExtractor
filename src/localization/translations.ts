...
const ja: TranslationSet = {
  ...
  settings: {themeEyebrow: 'テーマ', themeTitle: '見た目を選ぶ', dataTypesEyebrow: 'データ種別', dataTypesTitle: '抽出する内容を選ぶ', dataTypesSubtitle: 'この設定は新しいスキャンすべてに適用されます。', themeUpdated: 'テーマを更新しました。', preferencesUpdated: '抽出設定を更新しました。', selectOneDataType: '少なくとも 1 つはデータ種別を選んでください。', languageEyebrow: '言語', languageTitle: 'アプリの言語', deviceLanguage: 'デバイスのデフォルト'},
...
const ko: TranslationSet = {
  ...
  settings: {themeEyebrow: '테마', themeTitle: '화면 스타일 선택', dataTypesEyebrow: '데이터 유형', dataTypesTitle: '추출할 항목 선택', dataTypesSubtitle: '이 설정은 앞으로의 모든 새 스캔에 적용됩니다.', themeUpdated: '테마가 업데이트되었습니다.', preferencesUpdated: '추출 설정이 업데이트되었습니다.', selectOneDataType: '최소 한 가지 데이터 유형을 선택하세요.', languageEyebrow: '언어', languageTitle: '앱 언어', deviceLanguage: '기기 기본값'},
...
const de: TranslationSet = {
  ...
  settings: {themeEyebrow: 'Design', themeTitle: 'Look auswahlen', dataTypesEyebrow: 'Datentypen', dataTypesTitle: 'Wahle, was extrahiert werden soll', dataTypesSubtitle: 'Diese Auswahl gilt appweit fur jeden neuen Scan.', themeUpdated: 'Design aktualisiert.', preferencesUpdated: 'Extraktionseinstellungen aktualisiert.', selectOneDataType: 'Wahle mindestens einen Datentyp aus.', languageEyebrow: 'Sprache', languageTitle: 'App-Sprache', deviceLanguage: 'Gerätestandard'},
...
const ptBR: TranslationSet = {
  ...
  settings: {themeEyebrow: 'Tema', themeTitle: 'Escolha um visual', dataTypesEyebrow: 'Tipos de dado', dataTypesTitle: 'Escolha o que extrair', dataTypesSubtitle: 'Essas selecoes valem para todo novo scan no app.', themeUpdated: 'Tema atualizado.', preferencesUpdated: 'Preferencias de extracao atualizadas.', selectOneDataType: 'Selecione pelo menos um tipo de dado.', languageEyebrow: 'Idioma', languageTitle: 'Idioma do app', deviceLanguage: 'Padrao do dispositivo'},
